...
{    
    ...
    public static void Initialize()
    {
        ...
        if (betaCheck >= 99)
        {
            ...
            {
                string message = String.Format("There are {0} days left of the uWebKit BETA period", betaCheck);

                if (betaCheck == 0)
                    message = String.Format("There is less than a day left of the uWebKit BETA period");
